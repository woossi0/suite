...
copyright = u'2005-14 OpenLayers Contributors'
...
html_theme_options = {
  ...
  'suite_url': 'openlayers' # the url path within Suite e.g. sdk-api for opengeo-docs/sdk-api
}
...
# pixels large.
html_favicon = '../../themes/suite_rtd_theme/static/img/openlayers.ico'
