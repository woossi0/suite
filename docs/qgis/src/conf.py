...
copyright = u'License <a rel="license" href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-ShareAlike</a>'
...
html_theme_options = {
  ...
  'suite_url': 'qgis' # the url path within Suite e.g. sdk-api for suite-docs/sdk-api
