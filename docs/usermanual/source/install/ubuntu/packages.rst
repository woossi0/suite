...
#. Add the Boundless repository:
   ...
   .. code-block:: bash
      ...
      echo "deb [arch=amd64] https://<username>:<password>@downloads-repo.boundlessgeo.com/server-repo/1.1.0/ubuntu trusty main" > /etc/apt/sources.list.d/boundless.list
