...
Boundless Server Composer is a tool for making web maps. Add data to GeoServer, publish layers, and make a map all in a clutter-free, easy-to-use interface.
