...
There are only a few steps in creating a basic web map with your data using the OpenGeo Suite. This section will guide you through the process—from loading data to a finished map. The following workflow assumes your data is stored as shapefiles, although there are many types of data formats that the OpenGeo Suite can load and publish.
