...
This tutorial provides a set of steps that users can follow to style layers using the MBStyle styling language. It was adapted from the :ref:`YSLD tutorial <cartography.ysld.tutorial>`.
