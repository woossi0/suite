...
The map image shows the heatmap transformation, as well as the original input data points and a basemap for context.
...
The heatmap surface, as seen in the image above, can also be produced by the following SLD:
