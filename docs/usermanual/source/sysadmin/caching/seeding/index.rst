...
The first case, generating tiles by the system administrator in a batch operation, is sometimes known as "preseeding", with the "pre-" suffix denoting that it often comes "before" the application is live.

This section will discuss considerations involved when seeding a cache in advance, as well as how to execute those requests.
