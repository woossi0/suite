...
#. Edit the file :file:`/etc/tomcat9/server.xml`. 
...
#. Open :file:`/etc/tomcat9/tomcat9.conf` and update the ``JAVA_HOME`` environment variable.::
...
#. Add the following parameter to :file:`/etc/tomcat9/server-opts/scale`
