...
Web SDK is available from `npm <https://www.npmjs.com/package/boundless-sdk>`_ or `GitHub <https://github.com/boundlessgeo/sdk>`_

To install WEB SDK using npm, run:
