.. _dataadmin.thedatabase.data.de9im:
...
`ST_Relate(geometry A, geometry B) <http://postgis.org/docs/ST_Relate.html>`_: Returns a text string representing the DE9IM relationship between the geometries. 
