...
* **Windows**: Extensions can be added by :ref:`manually copying the extension files <intro.installation.windows.install.extensions>` after Boundless Suite is installed.
