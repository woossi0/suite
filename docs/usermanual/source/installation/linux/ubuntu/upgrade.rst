.. _installation.linux.ubuntu.upgrade:

Upgrading OpenGeo Suite for Ubuntu
==================================
...
You may now install the new version of OpenGeo Suite. See :ref:`installation.linux.ubuntu` for details.
