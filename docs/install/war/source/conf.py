...
project = u'Installing the OpenGeo Suite for Application Servers'
...
html_short_title = "Suite Install for App Servers"
...
latex_documents = [
  ('index', 'README-war.tex', u'OpenGeo Suite for Application Servers',
   u'OpenGeo', 'howto'),
]
